  ...
  <div>
    <div class="bg-white mb-16">
      <div class="container py-10 pb-16">
          <div class="w-10/12">
            <h1 class="text-4xl text-gray-700 font-medium leading-tight mb-4">Snippets Title</h1>
    ...
    <div class="container">
      <h1 class="text-xl text-gray-600 font-medium mb-6">1/1. Step Title</h1>
      <div class="flex flex-wrap lg:flex-nowrap">
        <div class="w-full lg:w-8/12 lg:mr-16 flex flex-wrap lg:flex-nowrap justify-between items-start mb-8">
          <div class="order-first">
            <nuxt-link
              :to="{name:'index'}"
              class="block mb-2 p-3 rounded-lg  mr-2 bg-blue-500"
            >
          ...
          <div class="bg-white rounded-lg p-8  text-gray-600 w-full lg:mr-2">Markdown Content</div>
          <div class=" flex flex-row lg:flex-col order-first lg:order-last">
            ...
            <nuxt-link
              :to="{name:'index'}"
              class="block mb-2 p-3 rounded-lg bg-blue-500 mr-2 lg:mr-0 order-first lg:order-last"
              title="Edit Step"
            >
